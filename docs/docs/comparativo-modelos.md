...
As seguintes métricas foram utilizadas na comparação:
- Acurácia
- Precisão
- Recall
- F1-Score
...
Como podemos ver na figura abaixo, com exceção ao _overfitting_, todos os modelos apresentaram valores semelhantes nas métricas. Mas, apesar da diferença de valores no _overfitting_, todos os modelos apresentaram valores muito próximos a 0 (zero), o que indica que os modelos realmente aprenderam com os dados e não somente "decoraram" os mesmos.

![Comparativo Métricas todos Modelos](img/etapa02_grafico_comparativo_metricas_modelos.png)

A tabela abaixo deixa mais clara essa comparação.

![Tabela Comparativa Métricas todos Modelos](img/etapa02_tabela_comparativa_metricas_modelos.png)
...
![Tabela Comparativa Custo/Benefício dos Modelos](img/etapa02_tabela_comparativa_custo_beneficio_modelos.png)
